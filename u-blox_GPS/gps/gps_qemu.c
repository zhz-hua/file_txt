...
nmea_tokenizer_init( NmeaTokenizer*  t, const char*  p, const char*  end )
{
    ...
    while (p < end) {
        ...
        q = memchr(p, ',', end-p);  //void * memchr(const void *s, char c, size_t n);
...
//******************************************************************	
				...
				LOGE("%d",gps_fd);
                        ...
                        if (started) {
                            ...
                            started = 0;
//********************************************************************
				g_status.status=GPS_STATUS_SESSION_END; //ֹͣ
				state->callbacks.status_cb(&g_status); 
//********************************************************************
...
//*****************************************************************************
    ...
    int err;
      ...
      tcflush(state->fd, TCIOFLUSH);//\D2\D4\CF\C2\CA\C7\C5\E4\D6ô\AE\BFڵĲ\CE\CA\FD
    ...
    if (cfsetispeed(&gps_termios,B9600))//\BE\DF\CC\E5\B5Ĳο\BCGPS\CEĵ\B5
